...
const createEnemySprites = (context: CanvasRenderingContext2D, level: TLevel, position: TPosition, actionSpriteConstants: TActionSpriteConstant) => (
    Object.fromEntries(
        Object.entries(actionSpriteConstants).map(
            ([action, spriteConstant]) => [
                action,
